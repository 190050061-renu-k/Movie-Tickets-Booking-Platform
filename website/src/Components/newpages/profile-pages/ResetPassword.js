...
const ResetPassword = (props) => {
    ...
    const handleFormChange = (event) => {
        ...
        switch (name) {
          case "oldpswd":
            errors.oldpswd =  value == "" ? "Required field" :(value.length<8 ? "Minimum length to be 8" : "");
            break;
          case "newpswd1":
            errors.newpswd1 = value == "" ? "Required field" :(value.length<8 ? "Minimum length to be 8" : "");
            break;
        case "newpswd2":
            errors.newpswd2 = value == "" ? "Required field" :(value.length<8 ? "Minimum length to be 8" : (value!=formValues.newpswd1 ? "Passwords don't match":""));
            break;
