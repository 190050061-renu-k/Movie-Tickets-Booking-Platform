  ...
  const handleSubmit = (event) => {
    ...
    if (validateForm(formValues.errors)) {
      ...
      fetch("http://localhost:3001/addMovie", {
        ...
        body: JSON.stringify({
          name: formValues.moviename,
          release_date: formValues.reldate,
          count_theatres: 0,
          upcoming: true,
          poster_img: formValues.inputimg,
          description: formValues.inputdesc,
          homepage: null,
          imdb_rating: null,
        }),
      }).then((response) => {
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ marginTop: "100px", marginLeft: "250px", width: "50%" }}
      >
