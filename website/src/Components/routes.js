...
import TheatreSeatSelection from "./newpages/theatre-pages/liveBookings/SeatSelection";
...
var routes = [
  ...
  {
    path: "/theatres/livebooking/:show_id", // :movie_id to be added
    name: "Live Booking",
    icon: "nc-icon nc-pin-3",
    component: TheatreSeatSelection,
    layout: "",
  },
];
